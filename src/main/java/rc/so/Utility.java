...
public class Utility {
    ...
    public static final String HOST = conf.getString("db.host") + ":3306/enm_gestione_toscana_prod";
    public static final String HOSTACCR = conf.getString("db.host") + ":3306/enm_toscana_prod";
